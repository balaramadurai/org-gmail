...
- Update a thread's label in Gmail to match a change you've made in your Org file.
- Bulk move all threads from one label to another, in both Gmail and your Org files.
...
#+BEGIN_SRC emacs-lisp
  (use-package org-gmail
    ...
    :commands (org-gmail-create-label
               ...
               org-gmail-update-label-at-point
...
- `M-x org-gmail-update-label-at-point`: If you've manually changed a `:LABEL:` property, this command syncs that change to Gmail.
